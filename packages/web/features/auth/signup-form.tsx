...
const inputClass =
  "mt-1.5 w-full glass rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-accent-violet/40 disabled:opacity-50 placeholder:text-muted-foreground/60";
    ...
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input id="password" name="password" type="password" placeholder="Create a password"
          ...
          required disabled={isLoading} className={inputClass} />
        <p className="mt-1 text-xs text-muted-foreground/70">At least 8 characters</p>
      </div>
