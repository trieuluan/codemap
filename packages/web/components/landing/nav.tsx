      ...
      <div className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <a href="#top" className="flex items-center gap-2.5">
            <span className="relative">
              ...
              >
                ...
                <path
                  d="M8 7l8 0M7.5 8 12 16M16.5 8 12.5 16"
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-ink-100">
            ...
            <a href="#mcp" className="hover:text-white transition">
              MCP tools
            </a>
            <a href="#editors" className="hover:text-white transition">
              Editors
            </a>
        ...
        <div className="flex items-center gap-2">
          <a
            href="/auth"
            className="text-sm text-ink-100 hover:text-white px-3 py-1.5"
          >
            Sign in
          </a>
          <a
            href="/auth/signup"
            className="btn-primary text-sm font-medium px-3.5 py-1.5 rounded-md"
          >
            Start free
          </a>
        </div>
