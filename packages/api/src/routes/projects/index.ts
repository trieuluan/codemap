...
const projectRoutes: FastifyPluginAsync = async (fastify): Promise<void> => {
  ...
  fastify.get("/:projectId/map/files", controller.getProjectFile);
  ...
  fastify.get("/:projectId/map/search/semantic", controller.searchProjectMapSemantic);
  ...
  fastify.get("/:projectId/map/symbol-graph", controller.getProjectSymbolGraph);
