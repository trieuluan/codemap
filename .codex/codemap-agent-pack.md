...
For broad tasks, agents should gather repository context first: use `explore_task` when files are unclear, `find_related_files` for scope questions, and `search_codebase` for known files, symbols, or keywords.
