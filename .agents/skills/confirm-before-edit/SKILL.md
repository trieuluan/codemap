...
Skill này chỉ áp dụng cho các file thuộc project `codemap` (root: `/sessions/ecstatic-wizardly-ritchie/mnt/codemap/`). Các file ngoài project (workspace tạm của Codex, file hệ thống) không yêu cầu confirm.
...
- Viết file tạm vào workspace riêng của Codex (ngoài thư mục project codemap).
...
- User bắt lỗi khi Codex hiểu sai intent trước khi thay đổi lan ra nhiều file.
- Tránh "surprise edits" khi Codex chạy tự động trên codebase của project.
